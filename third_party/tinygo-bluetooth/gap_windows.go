...
type windowsAdvertisementReceivedEventArgs2 struct {
	ole.IInspectable
}

type windowsAdvertisementReceivedEventArgs2Vtbl struct {
...
func (v *windowsAdvertisementReceivedEventArgs2) VTable() *windowsAdvertisementReceivedEventArgs2Vtbl {
...
//
// On Linux, the IsRandom part of the address is ignored.
func (a *Adapter) Connect(address Address, params ConnectionParams) (Device, error) {
	...
	var bleDeviceOp *foundation.IAsyncOperation
	var err error
	if address.IsRandom() {
		bleDeviceOp, err = bluetooth.BluetoothLEDeviceFromBluetoothAddressWithBluetoothAddressTypeAsync(winAddr, bluetooth.BluetoothAddressTypeRandom)
	} else {
