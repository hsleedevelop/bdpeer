...
- v0.5.22부터 macOS BLE central은 스캔 옵션과 중복 peripheral 처리, 연결 타임아웃 처리를 v0.4.4에 가깝게 좁혀 CoreBluetooth의 OS callback을 우선 신뢰합니다. 필요 시 `BDPEER_DARWIN_BLE_STARTUP_SCAN_SECONDS=30 ./bdpeer`처럼 실행해 BLE powered-on 이후 startup scan을 더 오래 유지하는 실험을 할 수 있습니다.
