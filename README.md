...
- v0.5.26부터 Windows BLE는 짧은 스캔 윈도우를 닫은 뒤 발견 후보에 연결해, Windows 스택이 스캔 중 연결 주소를 찾지 못하던 문제를 줄입니다.
